 ...
 * <p>
 * It provides utility methods for creating {@link TopologyBuilder} instances and accessing
...
abstract class AbstractTopologyPartBuilder<K,V> {
	...
	/**
	 * Creates a new instance of {@link TopologyBuilder} for the input stream with the shared
	 * key and value serdes and the shared topics base name.
	 *
	 * @param stream the input stream to create the topology builder for
	 * @return a new instance of {@link TopologyBuilder}
	 */
	...
	/**
	 * Returns a new instance of {@link TopologyBuilder} for the input stream with the shared topics base name.
	 *
	 ...
	 * @return a new instance of {@link TopologyBuilder} for the input stream with the shared topics base name
	 */
